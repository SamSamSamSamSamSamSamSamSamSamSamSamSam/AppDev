...
import { faUserCircle, faBell, faComments } from '@fortawesome/free-solid-svg-icons';
import Badge from '@mui/material/Badge';
import '../Styles/Nav_Bar.css';
import ChatBotMiniChatBox from './ChatBotModal';  // Import the ChatBotMiniChatBox
...
const NavBar = ({ notifications }) => {
  ...
  const [isChatBotOpen, setChatBotOpen] = useState(false);  // State to manage the ChatBot visibility
  ...
  return (
    <div className="navbar">
      <div className="navbar-container">
        ...
        <div className="dropdown">
          ...
          <button
            className="chatbot"
            type="button"
            onClick={toggleChatBot}  // Open the ChatBot modal
          >
      ...
      {/* ChatBotMiniChatBox */}
      {isChatBotOpen && <ChatBotMiniChatBox />}
    </div>
  );
};
