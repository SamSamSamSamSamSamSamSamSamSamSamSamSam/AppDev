            ...
            <Box sx={{ width: '500px' }}>
              ...
              <FormControl fullWidth variant="outlined">
                ...
                >
                  ...
                  <MenuItem value={"Sarah"}>Sarah Ordonez</MenuItem>
                  <MenuItem value={"Kyle"}>Kyle Tubod</MenuItem>
                  <MenuItem value={"Rei"}>Rei Jiro Lao</MenuItem>
                  <MenuItem value={"Sam"}>Sam Sam</MenuItem>
